    ...
    def load_model(self):
        ...
        if torch.cuda.is_available():
            ...
            if num_gpus < 2:
                ...
                model = LoaderClass.from_pretrained(model_path, trust_remote_code=True).half().cuda()
                # model = load_checkpoint_and_dispatch(model, model_path, device_map="balanced", offload_folder="offload", offload_state_dict=True, no_split_module_classes=["GLMBlock"]).half()
